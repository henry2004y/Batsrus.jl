...
tJulia = [163.36 * 1.0e-6, 180.8 * 1.0e-3, 1.32]
tPython = [4390.95 * 1.0e-6, 179.5 * 1.0e-3, 1.34]
tIDL = [1970.29 * 1.0e-6, 453.5 * 1.0e-3, 6.08]
tMatlab = [19273.25 * 1.0e-6, 698.4 * 1.0e-3, 10.6]
