...
function _get_system_units(typeunit::AbstractString)
    ...
    if typeunit == "SI"
        return (
            Unitful.m, Unitful.s, Unitful.kg / Unitful.m^3, Unitful.m / Unitful.s,
    ...
    elseif typeunit == "CGS"
        ...
        return (
            Unitful.cm, Unitful.s, Unitful.g / Unitful.cm^3,
            Unitful.cm / Unitful.s, Unitful.dyn / Unitful.cm^2,
            Unitful.Gauss, Unitful.A / Unitful.m^2,
        ) # J in CGS is tricky, defaulting to SI-like or just A/m^2 for validity
    elseif typeunit == "PLANETARY"
        return (
            UnitfulBatsrus.Re, Unitful.s, UnitfulBatsrus.amucc,
            Unitful.km / Unitful.s, Unitful.nPa, Unitful.nT, Unitful.μA / Unitful.m^2,
        )
    elseif typeunit == "OUTERHELIO"
        return (
            UnitfulBatsrus.AU, Unitful.s, UnitfulBatsrus.amucc, Unitful.km / Unitful.s,
    ...
    elseif typeunit == "SOLAR"
        ...
        return (
            Unitful.NoUnits, Unitful.NoUnits, Unitful.NoUnits, Unitful.NoUnits,
